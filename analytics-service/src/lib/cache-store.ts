...
export class CacheStore {
  ...
  async init(): Promise<void> {
    ...
    await this.loadNdjson<Product>(this.productsPath, (p) => this.productById.set(p.id, p));
    await this.loadNdjson<Rental>(this.rentalsPath, (r) => this.rentalById.set(r.id, r));
